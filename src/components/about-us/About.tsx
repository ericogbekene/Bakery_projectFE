    ...
    <div className="flex flex-col items-center justify-center w-full p-2">
      <div>
        ...
        <div className="p-2 m-2">
          ...
          <div className="flex flex-col justify-center gap-5 md:flex-row gap-3 items-center md:items-start">
            <Image
              src={foundersImg}
              alt="founders"
        ...
        <section className="w-full max-w-[1200px] flex flex-wrap sm:flex-col md:flex-row justify-center gap-4 items-center my-4">
